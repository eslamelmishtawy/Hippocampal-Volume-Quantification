...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    draw.multiline_text((10, 90),
                        ...
                        f"Inferred HippoCampus volume (anterior): {inference['anterior']}mm³\n",
                        f"Inferred HippoCampus volume (posterior): {inference['posterior']}mm³\n",
                        f"Total inferred HippoCampus volume: {inference['total']} mm³\n",
...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"C:/Users/Sola/Desktop/project/nd320-c3-3d-imaging-starter-master/model.pth")
    ...
    report_save_path = r"C:/Users/Sola/Desktop/project/nd320-c3-3d-imaging-starter-master/section3/out/report.dcm"
    ...
    os_command("storescu 127.0.0.1 1062 -v -aec HIPPOAI C:/Users/Sola/Desktop/project/nd320-c3-3d-imaging-starter-master/data/TestVolumes")
